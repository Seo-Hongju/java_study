...
public class Array01_1 {
	...
	public static void main(String[] args) {
		...
		/*
		자바에서는 배열을 클래스를 통해 생성하게 된다. 생성된
		배열은 힙(Heap)영역에 저장되고, 할당된 메모리의 주소값을
		...
		//2번방에 저장된 30이 출력
		System.out.println("numArr의 2번방의 값:"+ 
				numArr[2]);		
		System.out.println("=========================");
		...
		/*
		선언된 배열의 초기화를 반복문을 통해 진행한다. 이와같이
		배열은 반복문을 통해 순차적인 접근이 가능하므로 변수가 
		많을수록 효율적이다. 
		...
		/*
		객체배열도 기본자료형배열을 선언하는것과 동일하게 
		사용한다. 단 객체배열에 저장되는 값은 실제값이 아닌
		주소값이라는것에 차이가 있다. 
		 */
		...
		/*
		자바컴파일러는 초기값의 갯수를 통해 크기를 결정할수 
		있기때문에 이런경우 크기는 생략하도록 약속되어있다. 
		 */
		...
		/*
		new 키워드 없이 초기값만으로도 배열을 선언할수 있다. 
		이 경우도 요소의 갯수를 통해 배열의 크기가 결정된다. 
		 */
