...
class Man{
	...
	public Man() {
		...
		않는다면 초기화가 되지않아 이름이 null로 출력될수있다.
		 */
...
public class BusinessManMain{
	...
	public static void main(String[] args) {
		...
		BusinessMan man1 = 
				new BusinessMan("홍길동","NAVER", "팀장");
		BusinessMan man2 = 
				new BusinessMan("김길동","DAUM", "부장");
