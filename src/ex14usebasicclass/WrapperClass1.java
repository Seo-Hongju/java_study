...
Wrapper클래스
	...
	-오토박싱 : 기본자료형이 자동으로 객체로 변경되는것을 뜻함
		예] int => Integer
	-오토언박싱 : 객체가 기본자료형으로 자동으로 변경되는것
...
public class WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		int result2 = n10Obj.intValue() + 
				n20Obj.intValue();/*
			Integer 객체를 Unboxing해주는 메소드를 통해 덧셈
			연산을 진행함.	
			*/
		...
		/*
		Wrapper클래스를 사용하는 이점
			: 정의된 많은 메소드를 사용하여 최대, 최소값 혹은
			진법변환등을 처리할 수 있다. 
		 */
		System.out.println("int형의 최대값:"+ 
				Integer.MAX_VALUE);
		System.out.println("int형의 최소값:"+ 
				Integer.MIN_VALUE);
