...
/*
BigInteger 클래스
	: int형이나 long형으로 표현할수 없는 매우 큰수를 연산하고자
	할때 사용한다. 매개변수로 전달시 반드시 문자열 형태로 전달
	해야 한다. 
 */
//long lngNum = 100000000000000000000;//코드작성불가		
BigInteger bigValue1 = 
...
System.out.println("두 실수의 덧셈결과(오차있음):"+ 
		(dbl1+dbl2));
System.out.println("두 실수의 곱셈결과(오차있음):"+ 
		(dbl1*dbl2));
