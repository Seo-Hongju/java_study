...
/*
와일드카드 : 패키지를 임포트할때 보통은 클래스명을 명시하지만
	특정 패키지의 모든 클래스를 임포트할때는 *를 사용한다. 
	*는 "모든것" 을 뜻한다. 
 */
import java.lang.*;
...
Object클래스
-자바에서의 최상위 클래스
-별도의 선언없이 Object클래스에 정의된 메소드를 사용할수 있다.
-개발자가 정의한 모든 클래스를 Object객체로 참조할수 있다. 
 */
...
/*
toString()메소드
-Object클래스에 정의된 메소드로 println()이 문자열을 출력하기
전에 자동으로 호출한다. 
