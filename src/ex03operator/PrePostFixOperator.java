...
public class PrePostFixOperator {
	...
	/*
	증가/감소(증감) 연산자
		: +1 혹은 -1 한것과 같은 결과를 반환한다. 
		주로 반복의 횟수를 카운트할때 사용된다. 
	...
	public static void main(String[] args) {
		...
		System.out.printf("num1=%d, num2=%d, num3=%d%n",
				num1, num2, num3);
		...
		///////////////////////////////////////
		/*
		삼항연산자 : if문과 비슷한 기능으로 조건이 참일때
		 	거짓일때를 분기하여 실행할수 있는 연산자이다. 
		 */
		int x = 100;
