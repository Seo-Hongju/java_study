...
public class PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		ex09package 하위에 ex09package.korea.util 패키지가
		생성되지만 이 두개는 서로 다른 패키지로 인식한다. 
		즉 클래스가 저장된 위치가 다르면 무조건 다른 패키지로 
		인식하므로 주의해야 한다. 따라서 해당 클래스에서는 
		ex09package.korea.util 패키지를 import해야 한다
		 */
		...
		System.out.println(
			ex09package.korea.util.CommonUtil.isNumber("백20"));
	}
}
