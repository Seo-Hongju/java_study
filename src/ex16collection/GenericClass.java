...
할수 있다. 자료형에 해당하는 부분을 대표문자 T(Type)으로 교체하고
객체생성시 자료형을 결정하기 위해 클래스명<T> 형태로 수정한다. 
 */
...
public class GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		각 객체생성시 T 부분을 해당 객체로 설정하므로 구현의 
		편의성이 보장된다. 
		 */
		...
		/*
		Orange박스를 생성하는 경우 T를 Orange타입으로 결정
		했으므로 다른 객체는 저장할수 없다. 즉 컴파일 오류가 
		발생되어 자료형에도 안전한 클래스가 된다. 
