...
public class ExceptionBasic01 {
	...
	public static void main(String[] args) {
		...
		*/		
		...
		방법1] read()와 같이 호출시 기본적인 예외를 가지고 있는
		메소드는 "예외던지기"와 같이 main() 밖으로 예외를 
		던져서 처리한다. 이 방법은 예외를 내부에서 처리하지않고
		무시하겠다는 의미이다. 
		
		public static void main(String[] args)
			throws IOException {
		
		main()함수 뒷부분에 throws 하여 예외를 함수 밖으로 
		던지는 처리를 한다. 
		 */
