...
public class R03_method {
	...
	public static void guguPrint() {
		for(int dan=2 ; dan<=9 ; dan++) {
			...
			System.out.println("");//하나의 단 출력후 줄바꿈
		}
	}
	...
	//매개변수X, 반환값O : 평균값을 반환하므로 double로 선언
	...
	public static void main(String[] args) {			
		...
		/*
		시나리오] sungjukResult() 메소드를 호출하면 국어,
		영어,수학점수를 입력받은후 평균값을 반환하도록 구현하시오.
		※매개변수X, 반환값O
		 */
		...
		/*
		시나리오] 정수 하나를 매개변수로 전달하면 1부터 해당 
		매개변수까지의 합을 구하여 결과값을 반환하는 메소드를 
		작성하시오.
		...
		/*
연습문제] 다음과 같은 출력결과를 보이는 프로그램을 메소드로 
구현하시오.
메소드명 : upgradeGugu()
실행결과] 
---------- java ----------
